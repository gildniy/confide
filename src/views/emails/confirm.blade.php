<h1>{{ Lang::get('confide.email.account_confirmation.subject') }}</h1>

<p>{{ Lang::get('confide.email.account_confirmation.greetings', array('name' => (isset($user['username'])) ? $user['username'] : $user['email'])) }},</p>
