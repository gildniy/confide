<form role="form" method="POST" action="{{ URL::to('/users/login') }}" accept-charset="UTF-8">
    ...
    <fieldset>
        <div class="form-group">
            ...
            <input class="form-control" tabindex="1" placeholder="{{ Lang::get('confide.e_mail') }}" type="text" name="email" id="email" value="{{ Input::old('email') }}">
        </div>
        <div class="form-group">
        <label for="password">
        ...
        <div class="checkbox">
            <label for="remember">
                <input tabindex="4" type="checkbox" name="remember" id="remember" value="1"> {{ Lang::get('confide.login.remember') }}
            </label>
        </div>
        ...
        @endif
        <div class="form-group">
            <button tabindex="3" type="submit" class="btn btn-default">{{ Lang::get('confide.login.submit') }}</button>
        </div>
    </fieldset>
</form>
